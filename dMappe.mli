...
module Custom : sig
  type ('a, 'b) t
  val mapx : ('a, 'b) t -> ('a, 'b) Mappe.Custom.t
  val mapy : ('a, 'b) t -> ('b, 'a) Mappe.Custom.t
  ...
  val merge : ('a, 'b) t -> ('a, 'b) t -> ('a, 'b) t
  val common : ('a, 'b) t -> ('a, 'b) t -> ('a, 'b) t
  val intersetx : ('a, 'b) t -> 'a Sette.Custom.t -> ('a, 'b) t
  val intersety : ('a, 'b) t -> 'b Sette.Custom.t -> ('a, 'b) t
  val diffsetx : ('a, 'b) t -> 'a Sette.Custom.t -> ('a, 'b) t
  val diffsety : ('a, 'b) t -> 'b Sette.Custom.t -> ('a, 'b) t
  val iter : ('a -> 'b -> unit) -> ('a, 'b) t -> unit
  val fold : ('a -> 'b -> 'c -> 'c) -> ('a, 'b) t -> 'c -> 'c
  val setx : ('a, 'b) t -> 'a Sette.Custom.t
  val sety : ('a, 'b) t -> 'b Sette.Custom.t
  val equalx : ('a, 'b) t -> ('a, 'b) t -> bool
  val equaly : ('a, 'b) t -> ('a, 'b) t -> bool
  val subsetx : ('a, 'b) t -> ('a, 'b) t -> bool
  val subsety : ('a, 'b) t -> ('a, 'b) t -> bool
