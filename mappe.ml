...
let rec compare_aux l1 l2 =
  ...
  | (Nodezz(l1, v1, d1, r1, _) :: t1, t2) ->
      compare_aux (l1 :: Nodezz(Emptyzz, v1, d1, r1, 0) :: t1) t2
  | (t1, Nodezz(l2, v2, d2, r2, _) :: t2) ->
      compare_aux t1 (l2 :: Nodezz(Emptyzz, v2, d2, r2, 0) :: t2)

let compare mapa mapb =
  compare_aux [mapa] [mapb]
...
module Make(Setkey : Sette.S) = struct
  ...
  let compare (mapa : 'a t) (mapb : 'a t) : int =
    compare_aux [mapa] [mapb]
