...
module Compare : sig
    val get_index : 'a compare -> 'b hashtbl -> 'a -> int
    val resize : 'a compare -> 'a hashtbl -> unit
    val add_aux : 'a compare -> 'a hashtbl -> 'a -> int -> unit
    val add : 'a compare -> 'a hashtbl -> 'a -> unit
    val find_or : 'a compare -> 'a hashtbl -> 'a -> (int -> 'a) -> 'a
    val merge : 'a compare -> 'a hashtbl -> 'a -> 'a
    val find : 'a compare -> 'a hashtbl -> 'a -> 'a
    val find_shadow :
      'a compare -> 'a hashtbl -> 'a -> ('a Weak.t -> int -> 'b) -> 'b -> 'b
    val remove : 'a compare -> 'a hashtbl -> 'a -> unit
    val mem : 'a compare -> 'a hashtbl -> 'a -> bool
    val find_all : 'a compare -> 'a hashtbl -> 'a -> 'a list
end
